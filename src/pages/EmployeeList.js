...
import { PeopleOutlineTwoTone, SortOutlined } from '@material-ui/icons';
...
const EmployeeList = () => {
    ...
    return (
        <>
           ...
           <Grid container alignItems='center'>
           <Grid item>
           <Button style={{marginLeft:'16px'}} variant="contained" color="primary" type="button" onClick={getXls} className={classes.newButton} >New</Button>
           </Grid>
           <Grid item sm={true} />
